...
#include "sato/runtime/runtime.h"
...
struct InnerMessage : public Message {
  InnerMessage(sato::InternalDefault d)
  ...
  InnerMessage(std::shared_ptr<sato::MessageRuntime> runtime,
  ...
  const ::sato::MessageInfo *GetMessageInfo() const override {
    return InnerMessage::GetMessageInfoStatic();
  }

  static const ::sato::MessageInfo *GetMessageInfoStatic() {
    static sato::MessageInfo info;
    ...
    info.fields_in_order[0] = std::make_shared<sato::PrimitiveFieldInfo>(
        "str", sato::FieldType::kFieldString, 10,
        offsetof(InnerMessage, str_));
    info.fields_in_order[1] = std::make_shared<sato::PrimitiveFieldInfo>(
        "f", sato::FieldType::kFieldUInt64, 20, offsetof(InnerMessage, f_));
    info.fields_in_order[2] = std::make_shared<sato::PrimitiveFieldInfo>(
        "e", sato::FieldType::kFieldEnum, 30, offsetof(InnerMessage, e_));
    info.fields_in_order[3] = std::make_shared<sato::PrimitiveFieldInfo>(
        "ev", sato::FieldType::kFieldEnum, 40, offsetof(InnerMessage, ev_),
        "EnumTest", true);
    info.fields_in_order[4] =
        std::make_shared<sato::UnionInfo>("uv", offsetof(InnerMessage, uv_));
    ...
    {
      auto u =
          std::static_pointer_cast<sato::UnionInfo>(info.fields_in_order[4]);
      u->fields_in_order.resize(2);
      u->fields_in_order[0] = std::make_shared<sato::UnionFieldInfo>(
          "uva", sato::FieldType::kFieldUInt32, 50, u->offset, 0);
      u->fields_in_order[1] = std::make_shared<sato::UnionFieldInfo>(
          "uvb", sato::FieldType::kFieldEnum, 60, u->offset, 1);
      // Add to fields map.
  ...
  static InnerMessage CreateMutable(void *addr, size_t size) {
    ...
    auto runtime = std::make_shared<sato::MutableMessageRuntime>(pb);
  ...
  sato::StringField str_;
  sato::Uint64Field<true, false> f_; // Fixed size.
  sato::EnumField<EnumTest, EnumTestStringizer, EnumTestParser> e_;
  sato::EnumVectorField<EnumTest, EnumTestStringizer, EnumTestParser, false>
      ev_;
  sato::UnionField<
      sato::UnionUint32Field<false, false>,
      sato::UnionEnumField<EnumTest, EnumTestStringizer, EnumTestParser>>
      uv_;
};
...
static absl::Status
InnerMessageDeserializeFromBuffer(Message &msg, sato::ProtoBuffer &buffer) {
...
static Message *
InnerMessageAllocateAtOffset(std::shared_ptr<::sato::MessageRuntime> runtime,
                             toolbelt::BufferOffset offset) {
...
InnerMessageAllocate(std::shared_ptr<::sato::MessageRuntime> runtime) {
...
InnerMessageMakeExisting(std::shared_ptr<::sato::MessageRuntime> runtime,
                         const void *data) {
...
static const sato::MessageInfo *InnerMessageMessageInfo() {
  return InnerMessage::GetMessageInfoStatic();
}

static bool InnerMessageHasField(const sato::Message &msg, int number) {
  const InnerMessage *m = static_cast<const InnerMessage *>(&msg);
  switch (number) {
  case 10:
...
static void *InnerMessageFindFieldByNumber(Message &msg, int number) {
  ...
  const sato::MessageInfo *info = InnerMessage::GetMessageInfoStatic();
...
static sato::BankInfo innerMessageBackInfo{
...
static struct InnerMessageBankRegister {
  InnerMessageBankRegister() {
    sato::PhaserBankRegisterMessage(InnerMessage::FullName(),
...
struct TestMessage : public Message {
  ...
  TestMessage(std::shared_ptr<sato::MessageRuntime> runtime,
              ::toolbelt::BufferOffset offset)
      : Message(runtime, offset),
        x_(offsetof(TestMessage, x_), HeaderSize() + 0, 0, 100),
        y_(offsetof(TestMessage, y_), HeaderSize() + 8, 1, 101),
  ...
  static TestMessage CreateReadonly(void *addr) {
    ...
    auto runtime = std::make_shared<sato::MessageRuntime>(pb);
    return TestMessage(runtime, pb->message);
  }

  static TestMessage CreateDynamicMutable(size_t initial_size = 1024) {
    ::toolbelt::PayloadBuffer *pb = sato::NewDynamicBuffer(initial_size);
    ::toolbelt::PayloadBuffer::AllocateMainMessage(&pb,
                                                   TestMessage::BinarySize());
    auto runtime = std::make_shared<sato::DynamicMutableMessageRuntime>(pb, ::free);
    auto msg = TestMessage(runtime, pb->message);
    msg.InstallMetadata<TestMessage>();
    return msg;
  }
  ...
  sato::PrimitiveVectorField<int32_t, false, false, true> &vi32() {
    return vi32_;
  }
  ...
  sato::MessageVectorField<InnerMessage> &vm() {
    vm_.Populate();
    return vm_;
  }
  ...
  sato::Uint32Field<false, false> x_;
  sato::Uint64Field<false, false> y_;
  sato::StringField s_;
  sato::IndirectMessageField<InnerMessage> m_;

  // Repeated fields.
  sato::PrimitiveVectorField<int32_t, false, false, true> vi32_;
  sato::StringVectorField vstr_;
  sato::MessageVectorField<InnerMessage> vm_;

  // Union fields.
  sato::UnionField<sato::UnionUint32Field<false, false>,
                     sato::UnionUint64Field<true, false>>
      u1_;
  sato::UnionField<sato::UnionInt64Field<false, false>,
                     sato::UnionStringField>
      u2_;
  sato::UnionField<sato::UnionInt64Field<false, false>,
                     sato::UnionMessageField<InnerMessage>>
      u3_;
...
static absl::Status
TestMessageDeserializeFromBuffer(Message &msg, sato::ProtoBuffer &buffer) {
...
static Message *
TestMessageAllocateAtOffset(std::shared_ptr<::sato::MessageRuntime> runtime,
                            toolbelt::BufferOffset offset) {
...
static std::pair<Message *, toolbelt::BufferOffset>
TestMessageAllocate(std::shared_ptr<::sato::MessageRuntime> runtime) {
  void *addr = toolbelt::PayloadBuffer::Allocate(
...
static const Message *
TestMessageMakeExisting(std::shared_ptr<::sato::MessageRuntime> runtime,
                        const void *data) {
...
static sato::BankInfo kTestMessageBackInfo{
...
static struct TestMessageBankRegister {
  TestMessageBankRegister() {
    sato::PhaserBankRegisterMessage(TestMessage::FullName(),
...
TEST(MessageTest, ProtobufSerializationSizeRepeatedPrimitive) {
  ...
  size_t expected_vi32_size =
      sato::ProtoBuffer::TagSize(104, sato::WireType::kLengthDelimited) +
      1 + 2;

  ASSERT_EQ(expected_vi32_size, msg.vi32_.SerializedSize());

  size_t expected_vstr_size =
      sato::ProtoBuffer::LengthDelimitedSize(105, 3) * 2;
...
TEST(MessageTest, ProtobufDeserializationBasic) {
  ...
  char *buffer = (char *)malloc(4096);
  TestMessage msg = TestMessage::CreateMutable(buffer, 4096);
  sato::ProtoBuffer pb_buffer(str);
...
TEST(MessageTest, Print) {
  ...
  // Let's use the sato bank to print the message.
...
TEST(MessageTest, MessageInfo) {
  ...
  const ::sato::MessageInfo *info = msg.GetMessageInfo();
...
TEST(MessageTest, PhaserBank) {
  char *buffer = (char *)malloc(4096);
  TestMessage msg = TestMessage::CreateMutable(buffer, 4096);
  auto status = ::sato::PhaserBankAllocate<InnerMessage>(
